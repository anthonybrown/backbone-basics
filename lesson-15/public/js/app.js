...
var BooksView = Backbone.View.extend({
  ...
  handleClick: function (e) {
    Backbone.history.navigation(e.target.getAttribute('href'), {trigger: true});
    e.preventDefault();
  }
});
...
var BookRouter = Backbone.Router.extend({
  ...
  list: function () {
    ...
    $('#main-content').empty().append(booksView.render().el);
  },

  add: function (id) {
    var addBookView = new AddBookView({ collection: this.books });
    $('#main-content').empty().append(addBookView.render().el);
  }
